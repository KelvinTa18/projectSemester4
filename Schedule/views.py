...
def read(request):
    ...
    return render(request, "../templates/schedule/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/schedule/readDetail.html", {'form': form})
...
def create(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/schedule/create.html", {'form': form})
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/schedule/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Schedule:read")
...
def list_attendance(request, id):
    ...
    return render(request, "../templates/schedule/list_attendance.html", {'form': form})
