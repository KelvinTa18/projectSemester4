...
def read(request):
    ...
    return render(request, "../templates/attendance/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/attendance/readDetail.html", {'form': form})
...
def create(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/attendance/create.html", {'form': form})
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/attendance/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Attendance:read")
