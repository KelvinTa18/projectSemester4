...
def read(request):
    ...
    return render(request, "../templates/rate/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/rate/readDetail.html", {'form': form})
...
#         return render(request, "../templates/rate/create.html", {'form': form})
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/rate/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Rate:read")
