...
def read(request):
    ...
    return render(request, "../templates/class/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/class/readDetail.html", {'form': form})
...
def create(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/class/create.html", {'form': form})
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/class/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Class:read")
