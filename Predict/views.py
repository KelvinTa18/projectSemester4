...
def choose(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/predict/table_predict.html", {'form': result, 'choiceRate': CHOICESRATE, 'choiceDistance': CHOICEDISTANCE_AS_CATEGORIES})
    else:
        form = {
            'student': Student.objects.all(),
            'class': Class.objects.all(),
        }
        return render(request, "../templates/predict/list_predict.html", {'form': form})
