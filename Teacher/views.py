...
def read(request):
    ...
    return render(request, "../templates/teacher/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/teacher/readDetail.html", {'form': form})
...
def create(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/teacher/create.html", {'form': form})
    # if request.method == "POST":
    #     data = SaveForm(request.POST)
    #     if data.is_valid():
    #         data = data.save(commit=False)
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/teacher/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Teacher:read")
...
def teachers(request):
    ...
    print("Total teachers:", total_teachers)  # Debugging line
    context = {
