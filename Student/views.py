...
def read(request):
    ...
    return render(request, "../templates/student/read.html", {'form': form})
...
def readDetail(request, id):
    try:
        ...
        return render(request, "../templates/student/readDetail.html", {'form': form})
...
def create(request):
    if request.method == "POST":
        ...
        return render(request, "../templates/student/create.html", {'form': form})
...
def update(request, id):
    try:
        ...
        if request.method == "POST":
            ...
            return render(request, "../templates/student/update.html", {'form': form})
    except Exception as s:
        messages.error(request, s)
        return redirect("Student:read")
